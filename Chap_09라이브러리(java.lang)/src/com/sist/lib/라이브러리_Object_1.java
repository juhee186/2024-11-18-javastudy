...
// toStirng() : 객체를 문자열 => 객체출력시 생략가능
/*
 *  Object 클래스
 *  1. 모든 클래스에 상속을 내리는 클래스
 *  2. Object 가장큰 데이터형 => 모든 데이터값을 받을 수 있다
 *     Object o=1
 *     Object o=""
 *     Object o=10.5
 *  3. 모든 객체가 사용할 수 있는 기능을 제공
 *    ----------------------------메소드
 *  4. java.lang => Object 외 다른 클래스는 final
 *  						 ----------------
 *  						상속을 받아 변경 불가능
 *  5. Object
 *    --------
